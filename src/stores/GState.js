...
export const useProductTab=defineStore('product_tab',//this is refered as 'productstore' in script setup 'Home' component
{
  ...
  ({
    product_tab:
    [
      {id:0,idt:'f2eh4y7fbhx684g',price:1,image:'/Products/Product1.png',title:'Gm1',description:'This is full product description'},
      {id:1,idt:'f2eh4y7fbhx684g',price:2,image:'/Products/Product2.png',title:'Gm12',description:'This is full product description'},
      {id:2,idt:'f2eh4y7fbhx684g',price:3,image:'/Products/Product3.png',title:'Gm123',description:'This is full product description'},
      {id:3,idt:'f2eh4y7fbhx684g',price:4,image:'/Products/Product6.png',title:'Gm1432',description:'This is full product description'},
      {id:4,idt:'f2eh4y7fbhx684g',price:5,image:'/Products/Product5.png',title:'Gm143653',description:'This is full product description'},
      {id:5,idt:'f2eh4y7fbhx684g',price:6,image:'/Products/Product4.png',title:'Gm165764',description:'This is full product description'},
      {id:6,idt:'f2eh4y7fbhx684g',price:7,image:'/Products/Product7.png',title:'Gm',description:'This is full product description'},
      {id:7,idt:'f2eh4y7fbhx684g',price:8,image:'/Products/Product8.png',title:'Gm',description:'This is full product description'},
      {id:8,idt:'f2eh4y7fbhx684g',price:9,image:'/Products/Product9.png',title:'Gm',description:'This is full product description'}
    ],
